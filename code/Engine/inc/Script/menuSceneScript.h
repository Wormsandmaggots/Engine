...
public:
    ...
    void start() override{
        ...
        sm.getSceneByName("KubaScene")->addEntity(clubE);
        ...
        //sm.getSceneByName("KubaScene")->addEntity(player3);
        //player3->getTransform()->setPosition(glm::vec3(2, -2.5, 0));
/*
        djE->addComponent(dj);
        sm.getSceneByName("KubaScene")->addEntity(djE);
        dj->getTransform()->setPosition(glm::vec3(2, -2.5, 0));
*/
        scianyE->addComponent(sciany);
        sm.getSceneByName("KubaScene")->addEntity(scianyE);
        ...
        sm.getSceneByName("KubaScene")->addEntity(barDrinksE);
        ...
        sm.getSceneByName("KubaScene")->addEntity(barmanE);
        ...
        sm.getSceneByName("KubaScene")->addEntity(pointLight);


        sm.getSceneByName("KubaScene")->addEntity(sun);
        sun->addComponent(sunLight);

        sm.getSceneByName("KubaScene")->addEntity(dancingRobots);
        dancingRobots->addComponent(ir);

        sm.getSceneByName("KubaScene")->addEntity(dancingRobots2);
        dancingRobots->addComponent(ir2);

        sm.getSceneByName("KubaScene")->addEntity(sphere1);
        sphere1->addComponent(sphere);
        sphere->getTransform()->setPosition(lightPos);

        //movement
        sm.getSceneByName("KubaScene")->addEntity(fm);
