...
//    exampleSceneScript(std::shared_ptr<EditorLayer::Editor> editor, std::shared_ptr<AudioManager> audioManager, std::shared_ptr<SceneManager> sm,
//                       PlayerInput playerInput, PlayerInput playerInput1, DebugInput debugInput,
//                       Shader shader, Shader shaderText, Shader shaderPbr, Shader screenShader, Shader imageShader, Shader imageShaderGreen,
//                       Renderer renderer, double lastTime) :
