...
int main() {
   ...
   // Model* sphereModel = new Model("res/content/models/sphere/untitled.obj");
    ...
    while (!glfwWindowShouldClose(s.window))
    {
        ...
        if (timeToDispense2 < 0 && songDataIndex < songData.size())
        {
            ...
            spawner.spawnBall("mid", glm::vec3(-songData[songDataIndex].bass.x, songData[songDataIndex].bass.y, -20), sphereModel);
            //spawner.spawnBall("high", glm::vec3(songData[songDataIndex].mid.x, songData[songDataIndex].mid.y, -20), sphereModel);
